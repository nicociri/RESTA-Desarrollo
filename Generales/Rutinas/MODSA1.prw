...
ListBoxIte() //Lista condiciones necesarias para la ejecusion del programa
List_Box() //Lista browser con ejemplo de la estructura que debe tener el excel 
...
AADD( aVetor, { "Carแcter de 6", "Carแcter de 2" , "N๚merico" , "N๚merico" , "Fecha" } ) 
...
AADD( aVetor, "1 - El c๓digo y tienda deben existir en el maestro de clientes")
