...
ฑฑบ Programa ณ compsx   บ Autor ณ TOTVS Protheus     บ Data ณ  24/07/2014 บฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function COMPSX( cEmpAmb, cFilAmb )
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSTProc  บ Autor ณ TOTVS Protheus     บ Data ณ  24/07/2014 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX2 บ Autor ณ TOTVS Protheus     บ Data ณ  24/07/2014 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de processamento da gravacao do SX2 - Arquivos      ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ FSAtuSX2   - Gerado por COMPADIC / Upd. V.4.10.6 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
aAdd( aSX2, { ;
	...
	'MAESTRO DE ACOPIOS'													, ; //X2_NOME
	'MAESTRO DE ACOPIOS'													, ; //X2_NOMESPA
	'MAESTRO DE ACOPIOS'													, ; //X2_NOMEENG
	0																		, ; //X2_DELET
	'C'																		, ; //X2_MODO
	''																		, ; //X2_TTS
	''																		, ; //X2_ROTINA
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX3 บ Autor ณ TOTVS Protheus     บ Data ณ  24/07/2014 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSX3, { ;
	...
	'@!'																	, ; //X3_PICTURE
	'A410Cli().And.A410ReCalc()'											, ; //X3_VALID
...
aAdd( aSX3, { ;
	...
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	"POSICIONE('SU5', 1, XFILIAL('SU5') + M->C5_XCONTAC,'U5_CONTAT')"		, ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
...
aAdd( aSX3, { ;
	...
	'Codigo Tabla de Precios'												, ; //X3_DESCSPA
	'Price List Code'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	'MaVldTabPrc(M->C5_TABELA,M->C5_CONDPAG,,M->C5_EMISSAO) .And. A410ReCalc()'	, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	'@E 99.99'																, ; //X3_PICTURE
	'(Positivo() .or. vazio()) .and. a410Recalc()'							, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	''																		, ; //X3_RELACAO
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Nro.Acopio'															, ; //X3_TITULO
	'Nro.Acopio'															, ; //X3_TITSPA
	'Nro.Acopio'															, ; //X3_TITENG
	'Nro.Acopio'															, ; //X3_DESCRIC
	'Nro.Acopio'															, ; //X3_DESCSPA
	'Nro.Acopio'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	'R'																		, ; //X3_CONTEXT
	''																		, ; //X3_OBRIGAT
	'U_ACOCLIEN()'															, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	'M->C5_XESACO=="S" .and. inclui .and. Empty(M->C5_XNROACO)'				, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
	'2'																		, ; //X3_FOLDER
	''																		} ) //X3_PYME
...
aAdd( aSX3, { ;
	...
	'Es acopio'																, ; //X3_TITSPA
	'Es acopio'																, ; //X3_TITENG
	'Es acopio'																, ; //X3_DESCRIC
	'Es acopio'																, ; //X3_DESCSPA
	'Es acopio'																, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	12																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Fact. Acopio'															, ; //X3_TITULO
	'Fact. Acopio'															, ; //X3_TITSPA
	'Fact. Acopio'															, ; //X3_TITENG
	'Factura de acopio'														, ; //X3_DESCRIC
	'Factura de acopio'														, ; //X3_DESCSPA
	'Factura de acopio'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	'R'																		, ; //X3_CONTEXT
	''																		, ; //X3_OBRIGAT
	'U_ENCFACT()'															, ; //X3_VLDUSER
	''																		, ; //X3_CBOX
	''																		, ; //X3_CBOXSPA
	''																		, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	"M->C5_XTPACO=='I'"														, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
	'2'																		, ; //X3_FOLDER
	''																		} ) //X3_PYME
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Facturacion'															, ; //X3_TITULO
	'Facturacion'															, ; //X3_TITSPA
	'Facturacion'															, ; //X3_TITENG
	'Facturacion'															, ; //X3_DESCRIC
	'Facturacion'															, ; //X3_DESCSPA
	'Facturacion'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	'1=Factura;2=Remito'													, ; //X3_CBOX
	'1=Factura;2=Remito'													, ; //X3_CBOXSPA
	'1=Factura;2=Remito'													, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	'Empty(M->C5_XNROACO)'													, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
	'1'																		, ; //X3_FOLDER
	''																		} ) //X3_PYME
...
aAdd( aSX3, { ;
	...
	10																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Obs. Acopio'															, ; //X3_TITULO
	'Obs. Acopio'															, ; //X3_TITSPA
	'Obs. Acopio'															, ; //X3_TITENG
	'Observaciones del acopio'												, ; //X3_DESCRIC
	'Observaciones del acopio'												, ; //X3_DESCSPA
	'Observaciones del acopio'												, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	60																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Pers. Autori'															, ; //X3_TITULO
	'Pers. Autori'															, ; //X3_TITSPA
	'Pers. Autori'															, ; //X3_TITENG
	'Persona Autorizada'													, ; //X3_DESCRIC
	'Persona Autorizada'													, ; //X3_DESCSPA
	'Persona Autorizada'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Es lista Aco'															, ; //X3_TITULO
	'Es lista Aco'															, ; //X3_TITSPA
	'Es lista Aco'															, ; //X3_TITENG
	'Es de la lista de acopio'												, ; //X3_DESCRIC
	'Es de la lista de acopio'												, ; //X3_DESCSPA
	'Es de la lista de acopio'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	16																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Cant. Deman'															, ; //X3_TITULO
	'Cant. Deman'															, ; //X3_TITSPA
	'Cant. Deman'															, ; //X3_TITENG
	'Cantidad demandada'													, ; //X3_DESCRIC
	'Cantidad demandada'													, ; //X3_DESCSPA
	'Cantidad demandada'													, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	...
	5																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Porcentaje'															, ; //X3_TITULO
	'Porcentaje'															, ; //X3_TITSPA
	'Porcentaje'															, ; //X3_TITENG
	'Porcentaje de quita'													, ; //X3_DESCRIC
	'Porcentaje de quita'													, ; //X3_DESCSPA
	'Porcentaje de quita'													, ; //X3_DESCENG
	'@E 99.99'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(160)					, ; //X3_USADO
	'GETSX8NUM("Z01","Z01_ACOPIO")'											, ; //X3_RELACAO
	''																		, ; //X3_F3
	0																		, ; //X3_NIVEL
	Chr(254) + Chr(192)														, ; //X3_RESERV
	''																		, ; //X3_CHECK
...
aAdd( aSX3, { ;
	...
	'Tipo'																	, ; //X3_TITSPA
	'Tipo'																	, ; //X3_TITENG
	'Tipo de acopio'														, ; //X3_DESCRIC
	'Tipo de acopio'														, ; //X3_DESCSPA
	'Tipo de acopio'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	'€'																		, ; //X3_OBRIGAT
	''																		, ; //X3_VLDUSER
	'I=Indeterminado;D=Determinado'											, ; //X3_CBOX
	'I=Indeterminado;D=Determinado'											, ; //X3_CBOXSPA
	'I=Indeterminado;D=Determinado'											, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	''																		, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
...
aAdd( aSX3, { ;
	...
	80																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Descripcion'															, ; //X3_TITULO
	'Descripcion'															, ; //X3_TITSPA
	'Descripcion'															, ; //X3_TITENG
	'Descripcion'															, ; //X3_DESCRIC
	'Descripcion'															, ; //X3_DESCSPA
	'Descripcion'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	60																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Razon Social'															, ; //X3_TITULO
	'Razon Social'															, ; //X3_TITSPA
	'Razon Social'															, ; //X3_TITENG
	'Razon Social'															, ; //X3_DESCRIC
	'Razon Social'															, ; //X3_DESCSPA
	'Razon Social'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Desc. 1'																, ; //X3_TITSPA
	'Desc. 1'																, ; //X3_TITENG
	'Descuento 1'															, ; //X3_DESCRIC
	'Descuento 1'															, ; //X3_DESCSPA
	'Descuento 1'															, ; //X3_DESCENG
...
aAdd( aSX3, { ;
	...
	'Desc. 2'																, ; //X3_TITSPA
	'Desc. 2'																, ; //X3_TITENG
	'Descuento 2'															, ; //X3_DESCRIC
	'Descuento 2'															, ; //X3_DESCSPA
	'Descuento 2'															, ; //X3_DESCENG
	'@E 99,999,999,999.9999'												, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Desc. 3'																, ; //X3_TITSPA
	'Desc. 3'																, ; //X3_TITENG
	'Descuento 3'															, ; //X3_DESCRIC
	'Descuento 3'															, ; //X3_DESCSPA
	'Descuento 3'															, ; //X3_DESCENG
	'@E 99,999,999,999.9999'												, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Desc. 4'																, ; //X3_TITSPA
	'Desc. 4'																, ; //X3_TITENG
	'Descuento 4'															, ; //X3_DESCRIC
	'Descuento 4'															, ; //X3_DESCSPA
	'Descuento 4'															, ; //X3_DESCENG
	'@E 99,999,999,999.9999'												, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	8																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Fch. Emissio'															, ; //X3_TITULO
	'Fch. Emissio'															, ; //X3_TITSPA
	'Fch. Emissio'															, ; //X3_TITENG
	'Fecha de emission'														, ; //X3_DESCRIC
	'Fecha de emission'														, ; //X3_DESCSPA
	'Fecha de emission'														, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Fch. Venc'																, ; //X3_TITSPA
	'Fch. Venc'																, ; //X3_TITENG
	'Fecha de vencimiento'													, ; //X3_DESCRIC
	'Fecha de vencimiento'													, ; //X3_DESCSPA
	'Fecha de vencimiento'													, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Posee seguro'															, ; //X3_TITULO
	'Posee seguro'															, ; //X3_TITSPA
	'Posee seguro'															, ; //X3_TITENG
	'Posee seguro'															, ; //X3_DESCRIC
	'Posee seguro'															, ; //X3_DESCSPA
	'Posee seguro'															, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'1er Tipo Seg'															, ; //X3_TITULO
	'1er Tipo Seg'															, ; //X3_TITSPA
	'1er Tipo Seg'															, ; //X3_TITENG
	'Primer tipo de seguro'													, ; //X3_DESCRIC
	'Primer tipo de seguro'													, ; //X3_DESCSPA
	'Primer tipo de seguro'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	...
	''																		, ; //X3_OBRIGAT
	"Pertence(' 12')"														, ; //X3_VLDUSER
	'1=Adjudicado;2=Anticipo'												, ; //X3_CBOX
	'1=Adjudicado;2=Anticipo'												, ; //X3_CBOXSPA
	'1=Adjudicado;2=Anticipo'												, ; //X3_CBOXENG
	''																		, ; //X3_PICTVAR
	'M->Z01_XSEG=="S"'														, ; //X3_WHEN
	''																		, ; //X3_INIBRW
	''																		, ; //X3_GRPSXG
	'2'																		, ; //X3_FOLDER
	''																		} ) //X3_PYME
...
aAdd( aSX3, { ;
	...
	20																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Nro. Poliza'															, ; //X3_TITULO
	'Nro. Poliza'															, ; //X3_TITSPA
	'Nro. Poliza'															, ; //X3_TITENG
	'Numero de poliza'														, ; //X3_DESCRIC
	'Numero de poliza'														, ; //X3_DESCSPA
	'Numero de poliza'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Cargo client'															, ; //X3_TITULO
	'Cargo client'															, ; //X3_TITSPA
	'Cargo client'															, ; //X3_TITENG
	'Con cargo al cliente'													, ; //X3_DESCRIC
	'Con cargo al cliente'													, ; //X3_DESCSPA
	'Con cargo al cliente'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Porcentaje'															, ; //X3_TITSPA
	'Porcentaje'															, ; //X3_TITENG
	'Porcentaje'															, ; //X3_DESCRIC
	'Porcentaje'															, ; //X3_DESCSPA
	'Porcentaje'															, ; //X3_DESCENG
	'@E 99.99'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'2do Tipo Seg'															, ; //X3_TITULO
	'2do Tipo Seg'															, ; //X3_TITSPA
	'2do Tipo Seg'															, ; //X3_TITENG
	'Segundo tipo de seguro'												, ; //X3_DESCRIC
	'Segundo tipo de seguro'												, ; //X3_DESCSPA
	'Segundo tipo de seguro'												, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	20																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'2da Poliza'															, ; //X3_TITULO
	'2da Poliza'															, ; //X3_TITSPA
	'2da Poliza'															, ; //X3_TITENG
	'Segunda Poliza'														, ; //X3_DESCRIC
	'Segunda Poliza'														, ; //X3_DESCSPA
	'Segunda Poliza'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	1																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Cargo clie 2'															, ; //X3_TITULO
	'Cargo clie 2'															, ; //X3_TITSPA
	'Cargo clie 2'															, ; //X3_TITENG
	'Cargo al cliente 2do'													, ; //X3_DESCRIC
	'Cargo al cliente 2do'													, ; //X3_DESCSPA
	'Cargo al cliente 2do'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	5																		, ; //X3_TAMANHO
	2																		, ; //X3_DECIMAL
	'Porcentaje 2'															, ; //X3_TITULO
	'Porcentaje 2'															, ; //X3_TITSPA
	'Porcentaje 2'															, ; //X3_TITENG
	'Segundo porcentaje'													, ; //X3_DESCRIC
	'Segundo porcentaje'													, ; //X3_DESCSPA
	'Segundo porcentaje'													, ; //X3_DESCENG
	'@E 99.99'																, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	6																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Cod.List.Pre'															, ; //X3_TITULO
	'Cod.List.Pre'															, ; //X3_TITSPA
	'Cod.List.Pre'															, ; //X3_TITENG
	'Cod. Lista de Precio'													, ; //X3_DESCRIC
	'Cod. Lista de Precio'													, ; //X3_DESCSPA
	'Cod. Lista de Precio'													, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	12																		, ; //X3_TAMANHO
	0																		, ; //X3_DECIMAL
	'Nro. Factura'															, ; //X3_TITULO
	'Nro. Factura'															, ; //X3_TITSPA
	'Nro. Factura'															, ; //X3_TITENG
	'Nro. Factura'															, ; //X3_DESCRIC
	'Nro. Factura'															, ; //X3_DESCSPA
	'Nro. Factura'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Dir. Obra'																, ; //X3_TITSPA
	'Dir. Obra'																, ; //X3_TITENG
	'Direccion de Obra'														, ; //X3_DESCRIC
	'Direccion de Obra'														, ; //X3_DESCSPA
	'Direccion de Obra'														, ; //X3_DESCENG
	'@!'																	, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	16																		, ; //X3_TAMANHO
	4																		, ; //X3_DECIMAL
	'Incremento %'															, ; //X3_TITULO
	'Incremento %'															, ; //X3_TITSPA
	'Incremento %'															, ; //X3_TITENG
	'Incremento %'															, ; //X3_DESCRIC
	'Incremento %'															, ; //X3_DESCSPA
	'Incremento %'															, ; //X3_DESCENG
	'@E 99,999,999,999.9999'												, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
aAdd( aSX3, { ;
	...
	'Observ.'																, ; //X3_TITSPA
	'Observ.'																, ; //X3_TITENG
	'Observaciones'															, ; //X3_DESCRIC
	'Observaciones'															, ; //X3_DESCSPA
	'Observaciones'															, ; //X3_DESCENG
	''																		, ; //X3_PICTURE
	''																		, ; //X3_VALID
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
	Chr(128) + Chr(128) + Chr(128) + Chr(128) + Chr(128) + ;
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSIX บ Autor ณ TOTVS Protheus     บ Data ณ  24/07/2014 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de processamento da gravacao do SIX - Indices       ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ FSAtuSIX   - Gerado por COMPADIC / Upd. V.4.10.6 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX6 บ Autor ณ TOTVS Protheus     บ Data ณ  24/07/2014 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de processamento da gravacao do SX6 - Parโmetros    ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ FSAtuSX6   - Gerado por COMPADIC / Upd. V.4.10.6 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
aAdd( aSX6, { ;
	...
	'MV_XDIANC'																, ; //X6_VAR
	'N'																		, ; //X6_TIPO
	'Cantidad de dias que se busca para atras de la'						, ; //X6_DESCRIC
	'Cantidad de dias que se busca para atras de la'						, ; //X6_DSCSPA
	'Cantidad de dias que se busca para atras de la'						, ; //X6_DSCENG
	'fecha'																	, ; //X6_DESC1
	'fecha'																	, ; //X6_DSCSPA1
	'fecha'																	, ; //X6_DSCENG1
	''																		, ; //X6_DESC2
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX7 บ Autor ณ TOTVS Protheus     บ Data ณ  24/07/2014 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de processamento da gravacao do SX7 - Gatilhos      ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ FSAtuSX7   - Gerado por COMPADIC / Upd. V.4.10.6 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
aAdd( aSX7, { ;
	...
	''																		, ; //X7_CHAVE
	'U'																		, ; //X7_PROPRI
	'M->C5_XESACO=="S"'														} ) //X7_CONDIC

aAdd( aSX7, { ;
	'C5_XESACO'																, ; //X7_CAMPO
	'002'																	, ; //X7_SEQUENC
	'Posicione("Z01",1,xFilial("Z01")+M->C5_XNROACO,"Z01_XCDTAB")'			, ; //X7_REGRA
	'C5_TABELA'																, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
...
aAdd( aSX7, { ;
	'C5_XESACO'																, ; //X7_CAMPO
	'003'																	, ; //X7_SEQUENC
	'POSICIONE("Z01",1,Xfilial("Z01")+M->C5_XNROACO,"Z01_XENVIO")'			, ; //X7_REGRA
	'C5_XENVIO'																, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
...
aAdd( aSX7, { ;
	'C5_XESACO'																, ; //X7_CAMPO
	'004'																	, ; //X7_SEQUENC
	'POSICIONE("Z01",1,Xfilial("Z01")+M->C5_XNROACO,"Z01_TIPO")'			, ; //X7_REGRA
	'C5_XTPACO'																, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
...
aAdd( aSX7, { ;
	'C5_XESACO'																, ; //X7_CAMPO
	'005'																	, ; //X7_SEQUENC
	'POSICIONE("Z01",1,Xfilial("Z01")+M->C5_XNROACO,"Z01_DESC1")'			, ; //X7_REGRA
	'C5_DESC1'																, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
...
aAdd( aSX7, { ;
	'C5_XESACO'																, ; //X7_CAMPO
	'006'																	, ; //X7_SEQUENC
	'POSICIONE("Z01",1,Xfilial("Z01")+M->C5_XNROACO,"Z01_DESC2")'			, ; //X7_REGRA
	'C5_DESC2'																, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
...
aAdd( aSX7, { ;
	'C5_XESACO'																, ; //X7_CAMPO
	'007'																	, ; //X7_SEQUENC
	'POSICIONE("Z01",1,Xfilial("Z01")+M->C5_XNROACO,"Z01_DESC3")'			, ; //X7_REGRA
	'C5_DESC3'																, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
...
aAdd( aSX7, { ;
	'C5_XESACO'																, ; //X7_CAMPO
	'008'																	, ; //X7_SEQUENC
	'POSICIONE("Z01",1,Xfilial("Z01")+M->C5_XNROACO,"Z01_DESC4")'			, ; //X7_REGRA
	'C5_DESC4'																, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
...
aAdd( aSX7, { ;
	'C5_XESACO'																, ; //X7_CAMPO
	'009'																	, ; //X7_SEQUENC
	'POSICIONE("Z01",1,Xfilial("Z01")+M->C5_XNROACO,"Z01_XOBS3")'			, ; //X7_REGRA
	'C5_XOBS3'																, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
...
aAdd( aSX7, { ;
	'C5_XESACO'																, ; //X7_CAMPO
	'010'																	, ; //X7_SEQUENC
	'POSICIONE("Z01",1,Xfilial("Z01")+M->C5_XNROACO,"Z01_CONTAT")'			, ; //X7_REGRA
	'C5_XCONTAC'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	'C5_XESACO'																, ; //X7_CAMPO
	'011'																	, ; //X7_SEQUENC
	'POSICIONE("Z01",1,Xfilial("Z01")+M->C5_XNROACO,"Z01_XPAUT")'			, ; //X7_REGRA
	'C5_XPAUT'																, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
...
aAdd( aSX7, { ;
	'C5_XESACO'																, ; //X7_CAMPO
	'012'																	, ; //X7_SEQUENC
	'POSICIONE("Z01",1,Xfilial("Z01")+M->C5_XNROACO,"Z01_XDIRO")'			, ; //X7_REGRA
	'C5_XNCONTA'															, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
	0																		, ; //X7_ORDEM
...
aAdd( aSX7, { ;
	'C5_XNROACO'															, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'Z01->Z01_XCDTAB'														, ; //X7_REGRA
	'C5_TABELA'																, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'S'																		, ; //X7_SEEK
	'Z01'																	, ; //X7_ALIAS
	1																		, ; //X7_ORDEM
	'Xfilial("Z01") +M->C5_XNROACO'											, ; //X7_CHAVE
	'U'																		, ; //X7_PROPRI
	''																		} ) //X7_CONDIC
...
aAdd( aSX7, { ;
	...
	'SA1'																	, ; //X7_ALIAS
	1																		, ; //X7_ORDEM
	'xFilial("SA1")+M->Z01_CLIENT'											, ; //X7_CHAVE
	'U'																		, ; //X7_PROPRI
	''																		} ) //X7_CONDIC
...
aAdd( aSX7, { ;
	'Z01_CLIENT'															, ; //X7_CAMPO
	'002'																	, ; //X7_SEQUENC
	'SA1->A1_DESC'															, ; //X7_REGRA
	'Z01_DESC1'																, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'S'																		, ; //X7_SEEK
	'SA1'																	, ; //X7_ALIAS
	1																		, ; //X7_ORDEM
	'xFilial("SA1")+M->Z01_CLIENT+M->Z01_LOJA'								, ; //X7_CHAVE
	'U'																		, ; //X7_PROPRI
	''																		} ) //X7_CONDIC
...
aAdd( aSX7, { ;
	'Z01_CONTAT'															, ; //X7_CAMPO
	'001'																	, ; //X7_SEQUENC
	'POSICIONE("SU5",1,Xfilial("SU5")+M->Z01_CONTAT,"U5_CONTAT")'			, ; //X7_REGRA
	'Z01_XDIRO'																, ; //X7_CDOMIN
	'P'																		, ; //X7_TIPO
	'N'																		, ; //X7_SEEK
	''																		, ; //X7_ALIAS
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSXA บ Autor ณ TOTVS Protheus     บ Data ณ  24/07/2014 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
...
aAdd( aSXA, { ;
	'Z01'																	, ; //XA_ALIAS
	'1'																		, ; //XA_ORDEM
	'Informacion Gral.'														, ; //XA_DESCRIC
	'Informacion Gral.'														, ; //XA_DESCSPA
	'Informacion Gral.'														, ; //XA_DESCENG
	'U'																		} ) //XA_PROPRI
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSXB บ Autor ณ TOTVS Protheus     บ Data ณ  24/07/2014 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de processamento da gravacao do SXB - Consultas Pad ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ FSAtuSXB   - Gerado por COMPADIC / Upd. V.4.10.6 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
aAdd( aSXB, { ;
	...
	'02'																	, ; //XB_SEQ
	'05'																	, ; //XB_COLUNA
	'Nro. Acopio'															, ; //XB_DESCRI
	'Nro. Acopio'															, ; //XB_DESCSPA
	'Nro. Acopio'															, ; //XB_DESCENG
	''																		} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'02'																	, ; //XB_SEQ
	'02'																	, ; //XB_COLUNA
	'Descripcion'															, ; //XB_DESCRI
	'Descripcion'															, ; //XB_DESCSPA
	'Descripcion'															, ; //XB_DESCENG
	'ALLTRIM(Z01_DESC)'														} ) //XB_CONTEM
...
aAdd( aSXB, { ;
	...
	'02'																	, ; //XB_SEQ
	'05'																	, ; //XB_COLUNA
	'Nro. Acopio Indef.'													, ; //XB_DESCRI
	'Nro. Acopio Indef.'													, ; //XB_DESCSPA
	'Nro. Acopio Indef.'													, ; //XB_DESCENG
	''																		} ) //XB_CONTEM
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX1 บ Autor ณ TOTVS Protheus     บ Data ณ  24/07/2014 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de processamento da gravacao do SX1 - Perguntas     ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ FSAtuSX1   - Gerado por COMPADIC / Upd. V.4.10.6 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
aAdd( aSX1, { ;
	'ACO005'																, ; //X1_GRUPO
	'03'																	, ; //X1_ORDEM
	'De Cliente	'															, ; //X1_PERGUNT
	'De Cliente	'															, ; //X1_PERSPA
	'De Cliente	'															, ; //X1_PERENG
	'mv_ch3'																, ; //X1_VARIAVL
	'C'																		, ; //X1_TIPO
	6																		, ; //X1_TAMANHO
	0																		, ; //X1_DECIMAL
...
aAdd( aSX1, { ;
	'ACO005'																, ; //X1_GRUPO
	'05'																	, ; //X1_ORDEM
	'De Sucursal	'															, ; //X1_PERGUNT
	'De Sucursal	'															, ; //X1_PERSPA
	'De Sucursal	'															, ; //X1_PERENG
	'mv_ch5'																, ; //X1_VARIAVL
	'C'																		, ; //X1_TIPO
	6																		, ; //X1_TAMANHO
	0																		, ; //X1_DECIMAL
...
aAdd( aSX1, { ;
	'ACO005'																, ; //X1_GRUPO
	'06'																	, ; //X1_ORDEM
	'A Sucursal	'															, ; //X1_PERGUNT
	'A Sucursal	'															, ; //X1_PERSPA
	'A Sucursal	'															, ; //X1_PERENG
	'mv_ch6'																, ; //X1_VARIAVL
	'C'																		, ; //X1_TIPO
	6																		, ; //X1_TAMANHO
	0																		, ; //X1_DECIMAL
...
aAdd( aSX1, { ;
	'ECREML'																, ; //X1_GRUPO
	'07'																	, ; //X1_ORDEM
	'Imprime precios?:'														, ; //X1_PERGUNT
	'Imprime precios?:'														, ; //X1_PERSPA
	'Imprime precios?:'														, ; //X1_PERENG
	'mv_ch7'																, ; //X1_VARIAVL
	'N'																		, ; //X1_TIPO
	1																		, ; //X1_TAMANHO
	0																		, ; //X1_DECIMAL
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ FSAtuSX9 บ Autor ณ TOTVS Protheus     บ Data ณ  24/07/2014 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบ Descricaoณ Funcao de processamento da gravacao do SX9 - Relacionament ณฑฑ
ฑฑบ          ณ                                                            บฑฑ
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑณ Uso      ณ FSAtuSX9   - Gerado por COMPADIC / Upd. V.4.10.6 EFS       ณฑฑ
ฑฑศออออออออออฯออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
ฑฑบ Programa ณ MyOpenSM0บ Autor ณ TOTVS Protheus     บ Data ณ  24/07/2014 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
