...
Static FUNCTION PrintHead()
   ...
   IF nLine >= BOTTOMPAGE
      ...
      _cCabec1 := "Numero        Fecha    Cod.        Nombre o Razon Social     REC.PR.    C.U.I.T.       Valores   Efectivo     Transf.    Retencion   Retencion  Retencion    Otras    Multas   Retencion   Total      Nros Comprob Ret  " //TYCO
...
Static FUNCTION PrintItem()
   ...
   If cAnulado != "X"
      ...
      @ nLine,  35 PSAY Left( AllTrim( SA1->A1_NOME ), 20 )
      @ nLine,  56 PSAY cProvis
...
// Agregue un digito mas a los totales
// pedido x Daniel Elisiri
// Nicolas Cirigliano 26/03/12
   @ nLine,  00 PSAY "TOTALES GENERALES:"
   @ nLine,  85 PSAY nTotCHQ PICTURE "99999999.99"
   @ nLine,  96 PSAY nTotEFE PICTURE "99999999.99"
   @ nLine, 107 PSAY nTotTRF PICTURE "99999999.99"
   @ nLine, 118 PSAY nTotGAN PICTURE "99999999.99"
   @ nLine, 129 PSAY nTotIVA PICTURE "99999999.99"
   @ nLine, 140 PSAY nTotIB  PICTURE "99999999.99"
   @ nLine, 151 PSAY nTotDiv PICTURE "99999999.99"
   @ nLine, 162 PSAY nTotMUL PICTURE "99999999.99"
   @ nLine, 173 PSAY nTotSUS PICTURE "99999999.99" //TYCO
   @ nLine, 185 PSAY nTotGRA PICTURE "99999999.99"           //TYCO
   nLine := nLine + 1
