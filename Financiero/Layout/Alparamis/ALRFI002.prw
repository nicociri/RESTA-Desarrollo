				...
				If nLastKey <> 27		
					...
					While (cAliasSE5)->(!Eof())
						IF (cAliasSE5)->E5_RECPAG == 'P'
							...
							aVar[10] := (cAliasSE5)->E5_SECNUM	// 10 - char
							aVar[11] := (cAliasSE5)->E5_HISTOR	// 11 - char
			
							cSecNumP := (cAliasSE5)->E5_SECNUM
						EndIF
						IF (cAliasSE5)->E5_RECPAG == 'R' .AND. cSecNumP == (cAliasSE5)->E5_SECNUM
							aVar[12] := (cAliasSE5)->E5_BANCO		// 12
							aVar[13] := (cAliasSE5)->E5_AGENCIA	// 13
							aVar[14] := (cAliasSE5)->E5_CONTA		// 14
							aVar[15] := (cAliasSE5)->E5_NATUREZ	// 15
							cSecNumR := (cAliasSE5)->E5_SECNUM
						EndIF
						cuenta++
					    DbSkip()
						IF cSecNumP == cSecNumR
