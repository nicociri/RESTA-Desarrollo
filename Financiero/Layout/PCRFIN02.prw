...
ฑฑบPrograma  ณPCRFIN02  บAutor  ณMicrosiga           บFecha ณ  03/18/09   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDesc.     ณ Layout de ordenes de pago.                                 บฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
WHILE ( SEK->EK_FILIAL + SEK->EK_ORDPAGO ) == cNroRec
	If SEK->EK_TIPODOC $ "CP-CT-RG-RI-RB"
		...
		ElseIf SEK->EK_TIPODOC == "RG"  .and. SEK->EK_TIPO = "IV-" .and.  (SEK->EK_VALOR > 0 .or. SEK->EK_VALOR< 0)   // Se agreg๓   "SEK->EK_VALOR< 0" para las retenciones de NCP.
		...
		ElseIf SEK->EK_TIPODOC == "RG" .and. SEK->EK_TIPO = "GN-" .and.  (SEK->EK_VALOR > 0 .or. SEK->EK_VALOR< 0)   // Se agreg๓   "SEK->EK_VALOR< 0" para las retenciones de NCP.
		...
		ElseIf SEK->EK_TIPODOC == "RG" .and. SEK->EK_TIPO = "IB-" .and. (SEK->EK_VALOR > 0 .or. SEK->EK_VALOR< 0)   // Se agreg๓   "SEK->EK_VALOR< 0" para las retenciones de NCP.
		...
		ElseIf SEK->EK_TIPODOC == "RG"  .and. SEK->EK_TIPO = "SU-" .and.(SEK->EK_VALOR > 0 .or. SEK->EK_VALOR< 0)   // Se agreg๓   "SEK->EK_VALOR< 0" para las retenciones de NCP.
		...
		ElseIf SEK->EK_TIPODOC == "RG"  .and. SEK->EK_TIPO = "SL-" .and.  (SEK->EK_VALOR > 0 .or. SEK->EK_VALOR< 0)   // Se agreg๓   "SEK->EK_VALOR< 0" para las retenciones de NCP.
