...
±±³Descrip.  ³ Impresión en la Orden de Pago                              ³±±
...
If MsgYesNo(OemToAnsi("Desea hacer la impresión de la/s orden/es de pago/s?"))
	U_PCRFIN02(aOrd[1][1][1],aOrd[1][Len(aOrd[1])][1])
EndIf

If MsgYesNo(OemToAnsi("Desea hacer la impresión de los certificados de retención?"))
...
±±ºPrograma  ³A085AFim  ºAutor  ³Microsiga           ºFecha ³  03/18/09   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Punto de entrada despues de la grabacion de la orden de    º±±
±±º          ³ pago.                                                      º±±
