...
ฑฑบPrograma  ณIMPSB9    บ Autor ณ 				   บ Data ณ             บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ Programa de Saldos de Stock                                บฑฑ
...
// ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
// ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออหออออออัอออออออออออออปฑฑ
// ฑฑบPrograma  ณ GrabaSB9 บ Autor ณ Ivaldo Junior      บ Data ณ  27/02/09   บฑฑ
// ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
// ฑฑบDesc.     ณExecuta a importa็ใo dos registros.                         บฑฑ
// ฑฑบ          ณ                                                            บฑฑ
// ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
...
For nX:=1 To Len(aImport)
	...
	If !DbSeek(xFilial("SB9")+aImport[nX][nPosCod]+aImport[nX][nPosLoc]) .And. Val(aImport[nX][nPosCos]) > 0
		...
		If lMsErroAuto
			ProcLogAtu("ERRO",'Atenci๓n',"Error en la importaci๓n de Movimientos Internos -> Saldos en Stock")
			If !ExistDir(cDirLog)		
				MakeDir(cDirLog)
			EndIf
			...
			nCantErr += 1
			/*
			ProcLogAtu("ERRO",'Aten็ใo',"Erro na importa็ใo de Saldo Inicial.")
...
/*		
			If _cLocaliz = "S"
				...
				If dbSeek(xFilial("SDA")+Alltrim(aImport[nX][nPosCod])+Alltrim(aImport[nX][nPosLoc]))
					...
					If lMsErroAuto
						ProcLogAtu("ERRO",'Aten็ใo',"Erro no enderecamento de Saldo Inicial.")
