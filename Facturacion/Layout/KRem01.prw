...
±±³Funci¢n   ³          ³ Autor ³ Enrique H. Caputto    ³ Data ³ 01/11/04 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descrip.  ³Layout de Remitos de Venta / Devolucion / terceros / Transf.³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Alteracao ³31/07/05 - Edson G. Barbosa - Lay-Out                       ³±±
±±³          ³18/08/05 - Edson G. Barbosa - Lay-Out incluir Observacao    ³±±
±±³          ³06/09/05 - Edson G. Barbosa - Qtde de Linhas p/ remitos     ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³ Uso      ³                                                            ³±±
...
*/
User Function KRem01 (cEspecie,cSerie,cRemito)
...
if !empty(cNumFact)
	@ nLin,038 PSAY ALLTRIM(Subst(ALLTRIM(cNumFact),1,15))
endif
nLin++
nLin++
@ nLin,050 PSAY Posicione('SE4',1,xFilial('SE4')+SF2->F2_COND,'E4_DESCRI')
...
EndIf
// agregado por carlos 4-4-14
@ 062,015 PSAY "Acopio : " + SF2->F2_XNROACO 
@ 063,015 PSAY "Control: " + Subst(SF2->F2_DOC,1,4)+'-'+Subst(SF2->F2_DOC,5,8)
...
AAdd( aRegs, { cPerg, "05", "Imprime precios?:", "Imprime precios?:", "Imprime precios?:", "mv_ch5", "N", 1 , 00, 0, "C", "", "mv_par05", "Si", "Si", "Si", "", "", "No", "No", "No", "", "", "", "", "", "", "", "", "", "", "", "", "", "","", "", "","","" } )
