...
If		cEspecie $ "NF   " .and. Substr(SF2->F2_SERIE,1,1) == 'A'
   oPrn:Say( nTop+290, nLef+1140, 'Código 01'	, oFont3, 100 )
ElseIf   cEspecie $ "NF   " .and. Substr(SF2->F2_SERIE,1,1) == 'B'          
   oPrn:Say( nTop+290, nLef+1140, 'Código 06'	, oFont3, 100 )
ElseIf   cEspecie $ "NF   " .and. Substr(SF2->F2_SERIE,1,1) == 'E'          
   oPrn:Say( nTop+290, nLef+1140, 'Código 19'	, oFont3, 100 )   
ElseIf 	cEspecie $ "NDC  " .and. Substr(SF2->F2_SERIE,1,1) == 'A'	
	oPrn:Say( nTop+290, nLef+1140, 'Código 02'	, oFont3, 100 )
ElseIf 	cEspecie $ "NDC  " .and. Substr(SF2->F2_SERIE,1,1) == 'B'	
	oPrn:Say( nTop+290, nLef+1140, 'Código 07'	, oFont3, 100 )
ElseIf 	cEspecie $ "NDC  " .and. Substr(SF2->F2_SERIE,1,1) == 'E'	
	oPrn:Say( nTop+290, nLef+1140, 'Código 04'	, oFont3, 100 )	
ElseIf 	cEspecie $ "NCC  " .and. Substr(SF1->F1_SERIE,1,1) == 'A'	
	oPrn:Say( nTop+290, nLef+1140, 'Código 03'	, oFont3, 100 )
ElseIf 	cEspecie $ "NCC  " .and. Substr(SF1->F1_SERIE,1,1) == 'B'	
	oPrn:Say( nTop+290, nLef+1140, 'Código 08'	, oFont3, 100 ) 
ElseIf 	cEspecie $ "NDC  " .and. Substr(SF2->F2_SERIE,1,1) == 'E'	
	oPrn:Say( nTop+290, nLef+1140, 'Código 04'	, oFont3, 100 )		
EndIf
...
EndIf
 ...
 // Numero y Fecha 
If mv_par04 < 3
	oPrn:Say( nTop+350, nLef+1672, '  Nº: ' + Left( SF2->F2_DOC, 4 ) + "-" + Right( SF2->F2_DOC, 8 )	, oFont4, 100 )
	oPrn:Say( nTop+400, nLef+1680, '  FECHA: ' + DToC( SF2->F2_EMISSAO ), oFontN, 100 )
Else
	oPrn:Say( nTop+350, nLef+1672, '  Nº: ' + Left( SF1->F1_DOC, 4 ) + "-" + Right( SF1->F1_DOC, 8 )	, oFont4, 100 )
