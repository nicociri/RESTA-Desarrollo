...
If inclui .AND. SC5->C5_DOCGER=="2" .AND. SC5->C5_CATPV<>GetMv("MV_CATPV") 
	...
	cQuery := " SELECT C5_XENDENT ENDENT,C5_FECENT FECENT FROM " + RetSqlName("SC5") 
	cQuery += " WHERE D_E_L_E_T_='' C5_NUM='"+SC5->C5_XPVTRO+"'"
	...
	cQuery := PLSAvaSQL(cQuery)
  	...
  	EndIf
		...
		TODO01->(DBGoTop())
    	SC5->C5_XENDENT:=TODO01->ENDENT
   		SC5->C5_FECENT :=TODO01->FECENT
...
±±ºPrograma  ³alTraeDEsc   ºAutor  ³Microsiga           º Data ³  09/23/10º±±
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÉÍÍÍÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍËÍÍÍÍÍÍÑÍÍÍÍÍÍÍÍÍÍÍÍÍ»±±
±±ºPrograma  ³APROV   ºAutor  ³Microsiga             ºFecha ³  12/30/13   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
