...
±±³Funcion   ³ ACO004      ³ Autor ³ Fernando Cardeza   ³ Data ³ 16.03.14 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descripcion Impresion de Formulario.                                   ³±±
...
tamanho:="G"
limite 	:=220
titulo 	:=PADC("Emisi¢n del formulario de acopios." ,74)
cDesc1 	:=PADC("Ser solicitado el Intervalo para la emisi¢n de los",74)
