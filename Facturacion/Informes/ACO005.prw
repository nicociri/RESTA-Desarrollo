...
Local cDescripcion:= "Informe global de acopio, con tiene las siguientes columnas: Nº de Acopio / Nº de Vendedor / Nº de Cliente / Nombre de Cliente / Fecha de Alta / Fecha de Vencimiento / Nombre de la Obra (contacto) / Monto Inicial (sin Impuestos) / Monto Inicial BK/ Saldo (sin impuestos)/ Saldo BK/ Nº de grupos acopiados en lista de acopio)/ Sucursal de Origen."
